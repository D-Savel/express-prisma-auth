...
var updateUserById = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var updateUser, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, dbRequest_js_1.updateById)(req, 'user')];
            case 1:
                updateUser = _a.sent();
                if (updateUser) {
                    (0, sendSuccess_js_1.sendSuccess)(res, 201, "User for Id: ".concat(req.params.id, " has been successfully updated"), { user: updateUser });
                }
                return [3 /*break*/, 3];
            case 2:
                error_1 = _a.sent();
