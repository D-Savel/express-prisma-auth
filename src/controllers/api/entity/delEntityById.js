...
var deleteById = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, dbRequest_js_1.delById)(req, 'user')];
            case 1:
                deletedUser = _a.sent();
                console.log('param in del', req.params.id);
                console.log('delete user response', deletedUser);
                if (deletedUser) {
                    (0, sendSuccess_js_1.sendSuccess)(res, 200, "User with Id: ".concat(req.params.id, " has been successfully deleted"), null);
                }
                return [3 /*break*/, 3];
            case 2:
                error_1 = _a.sent();
