...
var entityNotMatches = function (entity) {
    return function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, dbRequest_js_1.getById)(req, entity)];
                case 1:
                    response = _a.sent();
                    ...
                    if ((0, isNull_js_1.default)([response])) {
                        throw new DatabaseError_js_1.DatabaseError("No ".concat(entity, " for request"));
                    }
                    else {
...
exports.default = entityNotMatches;
